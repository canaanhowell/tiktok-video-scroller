...
const bunnyVideos = [
  {
    ...
    username: 'goldenhourstudios',
    description: 'Golden Hour Studios - Romance Wedding Video 1 💕',
    likes: 1234,
    comments: 56,
    shares: 12,
    category: 'photographers',
    vendorName: 'Golden Hour Studios',
    vendorWebsite: 'www.goldenhourstudios.com',
  ...
  },
  {
    ...
    username: 'cinematicweddings',
    description: 'Cinematic Weddings - Romantic Moments 💍',
    likes: 5678,
    comments: 234,
    shares: 89,
    category: 'videographers',
    vendorName: 'Cinematic Weddings',
    vendorWebsite: 'www.cinematicweddings.com',
    vendorCity: 'Memphis',
    vendorState: 'Tennessee',
    vendorZipcode: '38103',
  },
  {
    ...
    description: 'Elegant Venues - Wedding Celebration 🎊',
    likes: 9012,
    comments: 345,
    shares: 123,
    category: 'venues',
  ...
  },
  {
    ...
    username: 'themusicmasters',
    description: 'The Music Masters - Love Story 💖',
    likes: 3456,
    comments: 123,
    shares: 45,
    category: 'musicians',
    vendorName: 'The Music Masters',
    vendorWebsite: 'www.themusicmasters.com',
    vendorCity: 'Knoxville',
    vendorState: 'Tennessee',
    vendorZipcode: '37902',
  },
  {
    ...
    description: 'DJ Spectacular - Forever Together 👰🤵',
    likes: 7890,
    comments: 456,
    shares: 234,
    category: 'djs',
