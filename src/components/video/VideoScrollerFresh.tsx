    ...
    >
      ...
      <div ref={containerRef} className="relative h-full w-full flex items-center justify-center -mt-[12%] md:mt-0" onClick={handleClick}>
        ...
        <div className="absolute bottom-[23%] md:bottom-[5%] left-1/2 transform -translate-x-1/2 z-40 flex gap-2">
          ...
          >
            <div className={`bg-[#f4c82d]/95 ${colorClasses.textPrimary} px-3 md:px-4 py-2 rounded-md hover:bg-[#f4c82d] transition flex flex-col items-center gap-1 w-[95px] md:w-auto`}>
              <h3 className="text-sm md:text-base font-semibold">Explore Vendor</h3>
          ...
          <Link 
            ...
            onClick={(e) => e.stopPropagation()}
          >
            <div className={`bg-[#dadde2]/95 ${colorClasses.textPrimary} px-3 md:px-4 py-2 rounded-md hover:bg-[#dadde2] transition flex flex-col items-center gap-1 w-[95px] md:w-auto`}>
              <h3 className="text-sm md:text-base font-semibold">Explore Music</h3>
